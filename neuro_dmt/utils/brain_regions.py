...
from dmt.vtk.utils.descriptor\
    import Field\
    ,      WithFCA
from dmt.vtk.utils.string_utils\
    import make_label\
    ,      make_name
...
class BrainRegion(
    ...
    label=\
        Field(
            __name__="label",
            __type__=str,
            __doc__="""Specify how to call this BrainRegion in reports and
            plots.""")
    acronyms=\
        Field(
            __name__="acronyms",
            __type__=list,
            __doc__="""A list of acronyms that may be used for this
            brain-region.""")
    subregions=\
        Field(
            __name__="subregions",
            ...
            __doc__="""You may specify the regions contained within this 
            BrainRegion. This enables a brain region hierarchy. Its value will 
    ...
    hierarchy_path=\
        Field.Optional(
            ...
            the root in a Brain Atlas. We make this Field optional, as a 
            concept that might become useful in the future. The inner tuples 
            should be type (str, int), with the first element an abbreviation,
             the second an integer.""",
            __examples__=[(('Br', 65535), ('SSCtx', 1100),
                           ('S1', 721), ('S1HL', 726))])
