...
class StructuredAnalysis(Analysis):
    ...
    #TODO: Resolve duplicated code between StructuredAnalysis and
    #BrainCircuitAnalysis. The code below has been pasted from HD's validations_library
    ...
    def get_measurements(self, adapter, model, sample_size=None):
        """
    ...
    def __call__(self,
        ...
        for i, model in enumerate(models):
            ...
            measurements[_label(model, default='model', i=i)] =\
                self.get_measurements(adapter, model)
