...
* Previous work
  Of course there is SciUnitTest. There is also the  [[https://bbpteam.epfl.ch/project/spaces/display/~palacios/Validation+API#ValidationAPI-Introduction][Validation API]], developed
  at BBP by Juan Pablo Palacios. None of the code referenced on the
...
** TODO Write about the three user-roles:  
